...
//  wind vane and anemometer: both are AS5600 magnetic encoders read via their PWM OUT pin
//  (no I2C); pins avoid ESP32-C6-DevkitM-1 strapping pins (GPIO4/5/8/9/15) and the USB-JTAG
//  pins (GPIO12/13) - double check against your actual wiring
#if USE_WIND_AS5600
